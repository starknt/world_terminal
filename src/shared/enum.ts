export namespace ModelConst {
  ...
  export const LEN_PET_STYLE = ModelConst.BIT_6
  export const LEN_PET_COLOR = ModelConst.BIT_2
  export const LEN_LVUP_STYLE = ModelConst.BIT_4
  export const LEN_SEX = ModelConst.BIT_1
  export const LEN_RACE = ModelConst.BIT_2
  export const LEN_JOB = ModelConst.BIT_4
  export const LEN_HAIR_STYLE = ModelConst.BIT_4
  export const LEN_HAIR_COLOR = ModelConst.BIT_2
  export const LEN_FACE_STYLE = ModelConst.BIT_4
  export const LEN_HAND_STYLE = ModelConst.BIT_2
  export const LEN_HAND_COLOR = ModelConst.BIT_2
  export const LEN_FEET_STYLE = ModelConst.BIT_2
  export const LEN_FEET_COLOR = ModelConst.BIT_2
  export const LEN_HELMET_STYLE = ModelConst.BIT_5
  export const LEN_HELMET_COLOR = ModelConst.BIT_2
  export const LEN_SHOULDER_STYLE = ModelConst.BIT_4
  export const LEN_SHOULDER_COLOR = ModelConst.BIT_2
  export const LEN_LWEAPON_STYLE = ModelConst.BIT_8
  export const LEN_LWEAPON_COLOR = ModelConst.BIT_2
  export const LEN_RWEAPON_STYLE = ModelConst.BIT_8
  export const LEN_RWEAPON_COLOR = ModelConst.BIT_2
  export const LEN_VIP = ModelConst.BIT_2
  export const LEN_WEAPON_FLASH = ModelConst.BIT_3
  export const LEN_SHOULDER_ADD = ModelConst.BIT_1
  export const LEN_BACK_STYLE = ModelConst.BIT_4
  export const LEN_BACK_COLOR = ModelConst.BIT_2
  export const LEN_CLOTHES_STYLE = ModelConst.BIT_6
  export const LEN_CLOTHES_COLOR = ModelConst.BIT_2
  export const LEN_TROUSERS_STYLE = ModelConst.BIT_6
  export const LEN_TROUSERS_COLOR = ModelConst.BIT_2
  export const LEN_TRANSPORT_STYLE = ModelConst.BIT_4
  export const LEN_TRANSPORT_COLOR = ModelConst.BIT_2
  export const LEN_BACK_ADD = ModelConst.BIT_1
  export const LEN_TRANSPORT_ADD = ModelConst.BIT_1
  export const LEN_FASH_ADD = ModelConst.BIT_1
  export const LEN_TRANSPORT_ADD_2 = ModelConst.BIT_1
  export const LONG_TROUSERS_IN_TRANSPORT = (7400 - ModelConst.START_TROUSERS) / 8 + 1
...
export const WS_GUANG_FANG_URL = 'wss://wanba.worldh5.com/websocket'
export const WS_CHANNEL_URL = 'wss://wanba.worldh5.com/K'
export const xcacheurl = 'http://192.168.1.120:9908/'
export const xprefix = 'http://192.168.1.120:5008/res?'
export const xserver = 'wss://wanba.worldh5.com/websocket'
export const xgameid = 1e3
export const xchannel = 1100
export const xhd = true
