...
export const LANG_DEFAULT = LANG_ZHCN
...
export const NEW_SCENE_DATA_FLAG
    ...
    | DATA_MONSTER_MODEL
    | DATA_MAP_IMAGE
export const LOGIN_DATA_FLAG = PLAYER_DATA_FLAG | DATA_NOTICE
export const SIMPLE_FLASH_DATA_FLAG = DATA_PLAYER_LIST_BASE
export const REFRESH_DATA_FLAG = PLAYER_DATA_FLAG | SIMPLE_FLASH_DATA_FLAG
export const JUMP_MAP_DATA_FLAG = SIMPLE_FLASH_DATA_FLAG
...
export const BALL_WEAPON_ID_AREA = ITEM_TYPE_WEAPON_ONEHAND_HAND + 1
export const BALL_WEAPON_ID_ONEHAND_GUN = ITEM_TYPE_WEAPON_ONEHAND_HAND + 2
export const BALL_WEAPON_ID_TWOHAND_GUN = ITEM_TYPE_WEAPON_ONEHAND_HAND + 3
...
export const raceJobList = [
  [JOB_RANGER, JOB_XIUZHEN],
  [JOB_WARRIOR, JOB_WIZARD],
]
...
export const ITEM_ID_JOB_START = ITEM_ID_RANGER
...
export const goodsType = [
  0,
  SEARCH_ITEM_TYPE_SWORD,
  SEARCH_ITEM_TYPE_BLADE,
  SEARCH_ITEM_TYPE_STICK,
  SEARCH_ITEM_TYPE_BOW,
  SEARCH_ITEM_TYPE_HAMMER,
  SEARCH_ITEM_TYPE_SPECIAL,
  SEARCH_ITEM_TYPE_BALL,
  SEARCH_ITEM_TYPE_ARMOR,
  SEARCH_ITEM_TYPE_JEWELRY,
  SEARCH_ITEM_TYPE_PET,
  SEARCH_ITEM_TYPE_GEM,
  SEARCH_ITEM_TYPE_MATERIAL,
  SEARCH_ITEM_TYPE_OTHER,
]
...
export const purchaseType = [
  -1,
  PURCHASE_ITEM_TYPE_GEM,
  PURCHASE_ITEM_TYPE_MATERIAL,
  PURCHASE_ITEM_TYPE_TASKITEM,
  PURCHASE_ITEM_TYPE_OTHER,
]
...
export const DONATE_DATA = [
  [
    [DONATE_TYPE_MONEY3, 1e4, 0],
    [DONATE_TYPE_MONEY3, 1e5, 0],
    [DONATE_TYPE_MONEY3, 1e6, 0],
  ],
  [
    [DONATE_TYPE_MONEY1, 10, 10],
    [DONATE_TYPE_MONEY1, 50, 50],
    [DONATE_TYPE_MONEY1, 100, 100],
  ],
  [
    [DONATE_TYPE_WOOD, 5, 1],
    [DONATE_TYPE_WOOD, 50, 10],
    [DONATE_TYPE_WOOD, 500, 100],
  ],
  [
    [DONATE_TYPE_STONE, 5, 1],
    [DONATE_TYPE_STONE, 50, 10],
    [DONATE_TYPE_STONE, 500, 100],
  ],
  [
    [DONATE_TYPE_IRON, 5, 1],
    [DONATE_TYPE_IRON, 50, 10],
    [DONATE_TYPE_IRON, 500, 100],
  ],
]
...
export const DONATE_MONEY3_VALUE = [
  [DONATE_TYPE_MONEY3, 1e4],
  [DONATE_TYPE_MONEY3, 1e5],
  [DONATE_TYPE_MONEY3, 1e6],
]
...
export const DONATE_MONEY1_VALUE = [
  [DONATE_TYPE_MONEY1, 10],
  [DONATE_TYPE_MONEY1, 50],
  [DONATE_TYPE_MONEY1, 100],
  [DONATE_TYPE_MONEY1, 500],
  [DONATE_TYPE_MONEY1, 1e3],
]
...
export const DONATE_STONE_VALUE = [
  [DONATE_TYPE_STONE, 5],
  [DONATE_TYPE_STONE, 50],
  [DONATE_TYPE_STONE, 500],
]
...
export const bindType = BIND_SETTING_SMS
